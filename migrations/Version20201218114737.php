 ...
 */
final class Version20201218114737 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE enqueteur (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, conversation_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, date_naissance DATE DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, tel INT DEFAULT NULL, mot_de_passe VARCHAR(255) DEFAULT NULL, matricule_fiscale VARCHAR(255) DEFAULT NULL, registre_des_commeerces LONGBLOB DEFAULT NULL, adresse_societe VARCHAR(255) DEFAULT NULL, logo LONGBLOB DEFAULT NULL, genre TINYINT(1) DEFAULT NULL, cin INT DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_33BC7EBFFB88E14F (utilisateur_id), INDEX IDX_33BC7EBF9AC0396 (conversation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, email VARCHAR(255) NOT NULL, tel INT DEFAULT NULL, genre TINYINT(1) DEFAULT NULL, mot_de_passe VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, cin INT NOT NULL, photo LONGBLOB DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
